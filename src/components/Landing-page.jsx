    ...
    <div className="cols-container">
      <div className="text-panel-div">
        ...
        <div className="subtitle-div">
          <div></div>
          <div><h2>Discover the full story - let AI guide you through every page.</h2></div>
          <div><button className="btn btn-style-lg" onClick={onButtonClick}>Upload PDF</button></div>
          <div><p>User guide</p></div>
        </div>
      </div>
    ...
    <div className="min-status-col">
      <div>
        <div className="hp-ctn-howItWorks">
          <button className="btn btn-style btn-style-square" onClick={onGoLandingPageClick}>upload <br></br> PDF</button>
        </div>
